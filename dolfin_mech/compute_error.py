...
def compute_error(
        ...
        ref):
    """
    Compute the relative error or ratio between a value and a reference.

    The error is calculated as:
    
    .. math::
    
        e = \\begin{cases} 0 & \\text{if } \\text{ref} \\approx 0 \\text{ and } \\text{val} \\approx 0 \\\\ 1 & \\text{if } \\text{ref} \\approx 0 \\text{ and } \\text{val} \\neq 0 \\\\ \\frac{\\text{val}}{\\text{ref}} & \\text{otherwise} \\end{cases}
