...
class SurfacePressureLoadingOperator(Operator):
    """
    Operator representing an external surface pressure (follower load) in a 
    large deformation (finite strain) framework.
...
class SurfacePressure0LoadingOperator(Operator):
    """
    Operator representing an external surface pressure in a 
