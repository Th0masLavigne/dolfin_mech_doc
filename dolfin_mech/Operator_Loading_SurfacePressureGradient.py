...
class SurfacePressureGradientLoadingOperator(Operator):
    """
    Operator representing an external surface pressure with a spatial gradient 
    ...
    def __init__(self,
        ...
        """
        Initializes the SurfacePressureGradientLoadingOperator.
...
class SurfacePressureGradient0LoadingOperator(Operator):
    """
    Operator representing an external surface pressure with a spatial gradient 
    in a small strain (linearized) framework.
